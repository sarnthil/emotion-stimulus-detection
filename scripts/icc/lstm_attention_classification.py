...
class ICC(Model):
    ...
    def forward(
        ...
        encoded_tokens = self.seq2seq_encoder(
            dropped_embedded_tokens, mask_tokens
        )
...
class MaskedMultiHeadSelfAttention(Seq2SeqEncoder):
    ...
    def __init__(
        ...
        self._combined_projection = Linear(
    ...
    def forward(
        ...
        expanded_mask = expanded_mask.unsqueeze(-1) * expanded_mask.unsqueeze(
            -2
        )
